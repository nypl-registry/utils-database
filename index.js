...
function Database () {
  ...
  this.returnCollections = function (collectionsName, cb) {
    // what gets sent back
    var returnCollections = {shadowcat: {}, registryIngest: {}, registryTripleStore: {}}
  ...
  this.prepareRegistryIngestSerialized = require(`${__dirname}/prepare/registry_ingest/serialized`)(this)
